...
//  val ROOT_REMOTE_EXTENSION = "https://raw.githubusercontent.com/Ferlab-Ste-Justine/cqdg-FHIR/master/fsh-generated/resources/"
  ...
  def init()(implicit fhirClient: IGenericClient): Unit = {
    ...
    Seq(
      ...
      "codesystems/CodeSystem-disease-status.json",
      "codesystems/CodeSystem-document-format.json",
      "codesystems/CodeSystem-duo-codes.json",
      ...
      "codesystems/CodeSystem-qc-sample-type.json",
      ...
      "valuesets/ValueSet-research-domain-vs.json",
    ...
    Seq(
      ...
      "stucturedefinitions/StructureDefinition-cqdg-organization.json",
